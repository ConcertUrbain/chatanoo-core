<?php
	...
	class Plugin_GetItemsWithDetailsByTag extends Plugin_Abstract
	{
	    /**
	    ...
	    /**
	     * Tableau contenant les passerelles vers les diffrentes tables de media
	     *
	     * @access protected
	     * @var array
	     */
		...
		public function execute()
		{
			...
			$items = $is->getItemsByMetaId($params[0]);
