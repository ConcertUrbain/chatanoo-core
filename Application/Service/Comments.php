<?php
  ...
  /**
   * Permet d'interagir avec les commentaires et la base de donnŽes
   *
                                           ...
                                           Service_Interface_Data
  {
      ...
      /**
       * Retourne toutes les commentaires contenus dans la base de donnŽes en
       * de options
       * Options:
      ...
      /**
       * Retourne un commentaire de la base de donnŽes en fonction de son
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Ajoute un commentaire ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Modifie un commentaire dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Comment comment Un commentaire
      ...
      /**
       * Supprime un commentaire de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int commentId Identifiant d'un commentaire
