<?php
  ...
  /**
   * Permet d'interagir avec les datas et la base de donnŽes
   *
  ...
  class Service_Datas  extends Service_Abstract
  {
      ...
      /**
       * Retourne toutes les datas contenues dans la base de donnŽes en fonction
       * options
       * Options:
      ...
      /**
       * Retourne une data de la base de donnŽes en fonction de son identifiant
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Ajoute une data ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Modifie une data dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Data_Abstract data Une data
      ...
      /**
       * Supprime une data de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int dataId Identifiant d'une data
