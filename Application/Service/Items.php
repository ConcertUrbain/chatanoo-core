<?php
  ...
  /**
   * Permet d'interagir avec les items et la base de donnŽes
   *
                                         ...
                                         Service_Interface_Data
  {
      ...
      /**
       * Retourne toutes les items contenus dans la base de donnŽes en fonction de
       * Options:
       * Options:
      ...
      /**
       * Retourne un item de la base de donnŽes en fonction de son identifiant
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retourne tous les items pour une metadonnée
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
    ...
    /**
       ...
       * @param  string mediaType Type du mŽdia (Picture, Sound, Video, Text)
       * @return array
       */
      ...
      /**
       * Ajoute un item ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Modifie un item dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Item item Un item
      ...
      /**
       * Supprime un item de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int itemId Identifiant d'un item
      ...
      /**
       * Retire un commentaire ˆ un item
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
