<?php
  ...
  /**
   * Permet d'interagir avec les mŽdias et la base de donnŽes
   *
  ...
  class Service_Medias extends Service_Abstract
  {
      ...
      /**
       * Tableau contenant les passerelles vers les diffŽrentes tables de mŽdias
       *
       * @access protected
       * @var array
       */
      ...
      /**
       * Retourne toutes les mŽdias contenus dans la base de donnŽes en fonction
       * options
       * Options:
      ...
      /**
       * Retourne un mŽdia de la base de donnŽes en fonction de son identifiant
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retourne tous les mŽdia contenus dans un item
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retourne tous les mŽdia contenus dans une question
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Ajoute un mŽdia ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Media_Abstract media Un mŽdia
       * @return int Identifiant du nouveau mŽdia
       */
      ...
      /**
       * Modifie un mŽdia dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Media_Abstract media Un mŽdia
      ...
      /**
       * Supprime un mŽdia de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int mediaId Identifiant d'un mŽdia
      ...
      /**
       * Ajoute un utilisateur au mŽdia
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int mediaId Identifiant du mŽdia
       * @param  string mediaType Type du mŽdia
       * @return void
       */
      ...
      /**
       * Retire un utilisateur du mŽdia
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      public function validateMedia($mediaId, $mediaType, $trueOrFalse)
      {
        ...
        $mediaRow = $this->_mediasTables[$mediaType]->fetchRow($select);
      $mediaRow->isValid = $trueOrFalse ? 1 : 0;
      return $mediaRow->save();
      }

      /**
       * Ajoute une data au mŽdia
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
