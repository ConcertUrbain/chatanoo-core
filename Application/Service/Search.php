<?php
  ...
  /**
   * Permet d'interagir avec les metas et la base de donnŽes aussi que faire des
   * dans celle-ci
   *
  ...
  class Service_Search extends Service_Abstract
  {
      ...
      /**
       * Passerelles vers la table des mŽtadonnŽes
       *
       * @access protected
       * @var Table_Metas
       */
      ...
      /**
       * Passerelles vers la table de liaison des mŽdtadonnŽes
       *
       * @access protected
       * @var array
       */
      ...
      /**
       * Retourne toutes les mŽtadonnŽes contenues dans la base de donnŽes en
       * de options
       * Options:
      ...
      /**
       * Retourne toutes les mŽtadonnŽes d'un ValueObject
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retourne une mŽtadonnŽes de la base de donnŽes en fonction de son
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retourne une mŽtadonnŽes de la base de donnŽes en fonction de son contenu
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  string metaContent Contenu de la mŽtadonnŽe
       * @return Vo_Meta
       */
      ...
      /**
       * Ajoute une mŽtadonnŽe ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Meta meta Une mŽtadonnŽe
       * @return int Identifiant de la nouvelle mŽtadonnŽe
       */
      public function addMeta( Vo_Meta $meta)
      {
      // On vŽrife que le tag n'hŽsite pas dŽjˆ
        $select = $this->_metasTable->select();
        $select->where('sessions_id = ?', Zend_Registry::get('sessionID'));
      ...
      /**
       * Modifie une mŽtadonnŽe dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Meta meta Une mŽtadonnŽe
      ...
      /**
       * Supprime une mŽtadonnŽe de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int metaId Identifiant d'une mŽtadonnŽe
      ...
      /**
       * Retourne tous les Value Object rŽpondant ˆ la requte
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  string request Requte ˆ ŽxŽcuter sur la base de donnŽes
       * @param  string section type de la recherche spŽcifiŽ dans le fichier de config
       * @return array
       */
       ...
       * @param  array config Configuration de la requte
       * @param  array search Elements recherchŽs
       * @return array
       */
