<?php
  ...
  /**
   * Permet d'interagir avec les sessions et la base de donnŽes
   *
                                          ...
                                          Service_Interface_Meta
  {
      ...
      /**
       * Retourne toutes les sessions contenus dans la base de donnŽes en fonction
       * options
       * Options:
      ...
      /**
       * Retourne une session de la base de donnŽes en fonction de son identifiant
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Ajoute une session ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Modifie une session dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_Session session Une session
      ...
      /**
       * Supprime une session de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int sessionId Identifiant d'une session
      ...
      /**
       * Ajoute une question ˆ une session dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Retire une question ˆ une session dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int queryId Identifiant d'une question
