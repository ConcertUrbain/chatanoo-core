<?php
  ...
  /**
   * Permet d'interagir avec les users et la base de donnŽes
   *
  ...
  class Service_Users extends Service_Abstract implements Service_Interface_Data
  {
      ...
      /**
       * Retourne toutes les utilisateurs contenus dans la base de donnŽes en
       * de options
       * Options:
      ...
      /**
       * Retourne un utilisateur de la base de donnŽes en fonction de son
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Ajoute un utilisateur ˆ la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
      ...
      /**
       * Modifie un utilisateur dans la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  Vo_User user Un utilisateur
    ...
    /**
      ...
      /**
       * Supprime un utilisateur de la base de donnŽes
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int userId Identifiant d'un utilisateur
      ...
      /**
       * Bannir ou dŽbannir un utilisateur
       *
       * @access public
       * @author Mathieu DesvŽ, <mathieu.desve@unflux.fr>
       * @param  int userId Identifiant d'un utilisateur
       * @param  bool trueOrFalse True pour bannir, false pour dŽbannir
       * @return void
       */
